...
export const getManualFacultyData = async () => {
    ...
    const res = await axios.get(url, {
        ...
        .catch((error) => {
            console.error('Faculty: ', error.response.data);
        });
    if (res) {
...
export const getManualResidentsData = async () => {
    ...
    const res = await axios.get(url, {
        ...
        console.error('Residents: ', error.response.data);
    });
    if (res) {
...
export const getManualFellowsData = async () => {
    ...
    const res = await axios.get(url, {
        ...
        .catch((error) => {
            console.error('Fellows: ', error.response.data);
        });
    if (res) {
...
export const getManualIndividualData = async () => {
    ...
    if(residents) {
        individuals.push(...residents);
    }
    if(fellows) {
        individuals.push(...fellows);
    }
    if(faculty) {
        individuals.push(...faculty);
    }
    /**
